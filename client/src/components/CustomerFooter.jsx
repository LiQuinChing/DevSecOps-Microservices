      ...
      <div className="max-w-7xl mx-auto px-10 py-10 grid md:grid-cols-4 gap-12 items-start text-left">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>
              <Link to="/order-products" className="hover:text-green-400 transition">
                Products
              </Link>
            </li>

            <li>
              <Link to="/payment" className="hover:text-green-400 transition">
                Make Payment
              </Link>
            </li>

            <li>
              <Link to="/payments" className="hover:text-green-400 transition">
                My Payments
              </Link>
            </li>
